...
export const GridBlockBackground = () => {
  return (
    <div className="absolute inset-0 h-full w-full pointer-events-none z-0">
      ...
      {/* Linear gradient for smooth bg transition */}
    </div>
  );
};
...
const Dot = () => {
  return (
    <div className="h-6 w-6 bg-content4 dark:bg-neutral-800 flex items-center justify-center rounded-full">
