...
export function HeroSectionWithBeamsAndGrid() {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-balance relative z-10 mx-auto mb-4 mt-4 max-w-4xl text-center text-3xl font-semibold tracking-tight text-gray-700 dark:text-neutral-300 md:text-7xl">
        <Balancer>
          Transform your,{' '}
          <strong className="text-primary">parking space</strong> into an
          effortless, passive stream of{' '}
          <strong className="text-primary">earnings</strong>.
        </Balancer>
      </h2>
      <p className="relative z-10 mx-auto mt-4 max-w-2xl px-4 text-center text-base/6 text-gray-600 dark:text-gray-200">
        Join our platform to connect with residents and visitors looking for
        convenient parking options. Easily list your space, set your own rates,
        and manage bookings with our user-friendly system. Help your community
        by providing much-needed parking solutions while maximizing your
        earnings with minimal effort.
      </p>
      <div className="flex sm:flex-row flex-col gap-6 md:gap-8 items-center mt-10 [perspective:800px] my-10">
      ...
      {/* <ContentLayout ref={containerRef} className="relative z-10">
        <GridLineHorizontal className="top-1" offset="200px" />
        <div className="w-full flex">
          <span className="w-full">Test asd asd asdas das das d</span>
        </div>
      </ContentLayout> */}
    </div>
  );
